...
function process_input(input){
        ...
        //       enableDelimiter();
        //}
        var opt=document.getElementById('source_data');
        var main_opt=opt[opt.selectedIndex].value;
        console.log(main_opt);
        if(main_opt=="DB"){
            $('#parentElementID').remove('#childElementID');
            document.getElementById('myFile').style.display="none";
            document.getElementById('loadFile0').style.display="none";
            document.getElementById('label2').style.display="none";
            document.getElementById('delimeter').style.display="none";
            document.getElementById('db_content').style.display="block";
            document.getElementById('label1').style.display="block";
            document.getElementById("source_data_db").style.display="block";
            document.getElementById("Db_conncetion").style.display="block";
            document.getElementById("label_db").style.display="block";
        }
        else {
            document.getElementById('myFile').style.display="inline"
            document.getElementById('loadFile0').style.display="inline";
            document.getElementById('label2').style.display="inline";
            document.getElementById('delimeter').style.display="block";
            document.getElementById('db_content').style.display="none";
            document.getElementById('label1').style.display="block";
            document.getElementById("source_data_db").style.display="none";
            document.getElementById("Db_conncetion").style.display="none";
            document.getElementById("label_db").style.display="none";
